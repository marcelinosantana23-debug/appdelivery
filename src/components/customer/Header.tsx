  ...
  return (
    <header className="relative w-full bg-white dark:bg-slate-900 shadow-sm border-b border-gray-100 dark:border-slate-800 transition-colors">
      ...
      <div className="relative h-44 w-full overflow-hidden bg-slate-900 sm:h-56 md:h-64">
        ...
        {/* Top Floating Toolbar (Trocar Loja, Área do Lojista, Super Admin) */}
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 rounded-full border border-white/20 bg-black/40 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur-md transition hover:bg-black/60 active:scale-95 shadow-lg"
              >
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="flex items-center gap-1.5 rounded-full border border-white/20 bg-black/40 px-3 py-1.5 text-xs font-semibold text-white/95 backdrop-blur-md transition hover:bg-black/60 active:scale-95 shadow-lg"
              ...
              >
                ...
                <span className="hidden xs:inline sm:inline">
                  {isSuperAdmin ? "Super Admin" : "Super Admin"}
                </span>
